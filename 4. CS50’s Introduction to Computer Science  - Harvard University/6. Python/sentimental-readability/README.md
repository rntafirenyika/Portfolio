...
url: https://cdn.cs50.net/2022/fall/psets/6/sentimental-readability/README.md
window: [terminal]
---
...
```
check50 cs50/problems/2022/fall/sentimental/readability
```
...
1. Click "Problem Set 6: Sentimental (Readability)".
1. Drag and drop your `readability.py` file to the area that says "Drag & Drop". Be sure it has that **exact** filename! If you upload a file with a different name, the autograder likely will fail when trying to run it, and ensuring you have uploaded files with the correct filename is your responsibility!
1. Click "Upload".
