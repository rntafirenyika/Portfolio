---
files: [mario.py]
url: https://cdn.cs50.net/2022/fall/psets/6/sentimental-mario-more/README.md
window: [terminal]
---
...
```
check50 cs50/problems/2022/fall/sentimental/mario/more
```
...
1. Click "Problem Set 6: Sentimental (Mario More)".
